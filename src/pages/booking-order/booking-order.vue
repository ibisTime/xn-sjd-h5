          ...
          <li class="item" v-for="(item, index) in currentList.data" @click="goDetail(item)">
            ...
            <div class="info">
              ...
              <div class="text">
                ...
                <div class="props">
                  <span class="duration">合计{{item.quantity}}件商品</span>
                  <span class="price" v-show="!item.jfDeductAmount && item.amount">¥{{formatAmount(item.amount)}}</span>
                  <span class="price" v-show="item.jfDeductAmount">¥{{formatAmount(item.payAmount)}}+{{formatAmount(item.jfDeductAmount)}}积分</span>
                </div>
              </div>
            </div>
